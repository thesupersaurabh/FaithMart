    ...
    <>
      <MainLayout>
        <div id="CheckoutPage" className="mt-4 max-w-[1100px] mx-auto">
          ...
          <div className="text-3xl font-semibold mt-4 mb-8">Checkout</div>
              ...
              <ClientOnly>
                <div className="p-4">
                  ...
                  <form onSubmit={pay}>
                    ...
                    <button
                      type="submit"
                      className="mt-4 bg-blue-600 text-lg w-full text-white font-semibold p-3 rounded-full hover:bg-blue-700 transition duration-300"
                    >
                      Confirm and Pay
                    </button>
                  </form>
